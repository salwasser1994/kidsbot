...
async def start_quiz(callback: CallbackQuery):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("Начать", callback_data="quiz_begin")],
        [InlineKeyboardButton("⬅️ Назад", callback_data="back")]
    ])
...
async def send_quiz_question(user_id, chat_id, result_text=""):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(opt, callback_data=f"quiz_ans:{i}")] for i, opt in enumerate(options)] + [[InlineKeyboardButton("⬅️ Назад в меню", callback_data="back")]])
